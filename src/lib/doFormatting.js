...
const stylish = {
  ...
  unchanged: ({ key, oldValue }, { depth }) => makeStrStylish(' ', key, oldValue, depth),

  removed: ({ key, oldValue }, { depth }) => makeStrStylish('-', key, oldValue, depth),

  added: ({ key, newValue }, { depth }) => makeStrStylish('+', key, newValue, depth),
